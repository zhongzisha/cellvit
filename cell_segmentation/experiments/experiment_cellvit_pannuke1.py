        ...
        **kwargs,
        ...
        if backbone_type.lower() == "default":
            ...
            if pretrained_model is not None:
                ...
                self.logger.info(model.load_state_dict(cellvit_pretrained['model_state_dict'] 
                    if 'model_state_dict' in cellvit_pretrained else cellvit_pretrained, strict=True))
