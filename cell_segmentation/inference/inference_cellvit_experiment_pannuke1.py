...
class InferenceCellViT:
    ...
    def plot_results(
        ...
        predictions = predictions.get_dict()
        ground_truth = ground_truth.get_dict()
        ...
        print('gt_sample_binary_map', gt_sample_binary_map.shape)
        print('pred_sample_binary_map', pred_sample_binary_map.shape)
        ...
        # for k,v in predictions.items(): print(k,v.shape if isinstance(v, torch.Tensor) else v)
        # for k,v in ground_truth.items(): print(k,v.shape if isinstance(v, torch.Tensor) else v)
        # pdb.set_trace()
        ...
        # for k,v in predictions.items(): print(k,v.shape)
        # for k,v in ground_truth.items(): print(k,v.shape)
        # pdb.set_trace()
